\hypertarget{prefinalizer_8h}{}\doxysection{prefinalizer.\+h File Reference}
\label{prefinalizer_8h}\index{prefinalizer.h@{prefinalizer.h}}
...
\end{DoxyCode}
Macro must be used in the private section of {\ttfamily Class} and registers a prefinalization callback {\ttfamily void Class\+::\+Pre\+Finalizer()}. The callback is invoked on garbage collection after the collector has found an object to be dead.
