\hypertarget{fast-api-call-lowering-reducer_8h}{}\doxysection{/mnt/\+V8\+Source\+Code/src/compiler/turboshaft/fast-\/api-\/call-\/lowering-\/reducer.h File Reference}
\label{fast-api-call-lowering-reducer_8h}\index{/mnt/V8SourceCode/src/compiler/turboshaft/fast-\/api-\/call-\/lowering-\/reducer.h@{/mnt/V8SourceCode/src/compiler/turboshaft/fast-\/api-\/call-\/lowering-\/reducer.h}}
...
\begin{center}
\leavevmode
\includegraphics[width=234pt]{fast-api-call-lowering-reducer_8h__dep__incl}
\end{center}
\end{figure}
