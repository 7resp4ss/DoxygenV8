...
\begin{center}
\leavevmode
\includegraphics[height=550pt]{classcppgc_1_1Heap__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=255pt]{classcppgc_1_1Heap__coll__graph}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\small\item\em Options specifying \mbox{\hyperlink{classcppgc_1_1Heap}{Heap}} properties (e.\+g. \end{DoxyCompactList}\item 
struct \mbox{\hyperlink{structcppgc_1_1Heap_1_1ResourceConstraints}{Resource\+Constraints}}
\begin{DoxyCompactList}\small\item\em Constraints for a \mbox{\hyperlink{classcppgc_1_1Heap}{Heap}} setup. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
, \mbox{\hyperlink{classcppgc_1_1Heap_a4be1c0d603f8273f64e771f60e22bb27afb089d072f99cd4e4deaa88c1bd80cae}{k\+No\+Conservative\+Stack\+Scan}}
 \}
\begin{DoxyCompactList}\small\item\em Specifies whether conservative stack scanning is supported. \end{DoxyCompactList}\item 
...
, \mbox{\hyperlink{classcppgc_1_1Heap_a3094861cfe8c736974723e4ad9ca3e20a13b93ce70f628c016cca112357cc51b1}{k\+Incremental\+And\+Concurrent}}
 \}
\begin{DoxyCompactList}\small\item\em Specifies supported marking types. \end{DoxyCompactList}\item 
...
, \mbox{\hyperlink{classcppgc_1_1Heap_a9005da6b2685669d9b1419324e26b8a2a13b93ce70f628c016cca112357cc51b1}{k\+Incremental\+And\+Concurrent}}
 \}
\begin{DoxyCompactList}\small\item\em Specifies supported sweeping types. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Specifies the stack state the embedder is in. \end{DoxyCompactList}\end{DoxyCompactItemize}
\doxysubsection*{Public Member Functions}
\begin{DoxyCompactItemize}
\item 
virtual \mbox{\hyperlink{classcppgc_1_1Heap_adb70bd8ece968e9201c13985c412d562}{$\sim$\+Heap}} ()=default
\item 
void \mbox{\hyperlink{classcppgc_1_1Heap_aa8ef2e6a66b5512a189ddfb7a3ab4f3d}{Force\+Garbage\+Collection\+Slow}} (const char $\ast$source, const char $\ast$reason, \mbox{\hyperlink{namespacecppgc_a91b484d5d6eea7664c25f4050c0d6eb8}{Stack\+State}} stack\+\_\+state=Stack\+State\+::k\+May\+Contain\+Heap\+Pointers)
\begin{DoxyCompactList}\small\item\em Forces garbage collection. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Creates a new heap that can be used for object allocation. \end{DoxyCompactList}\end{DoxyCompactItemize}
\doxysubsection*{Private Member Functions}
\begin{DoxyCompactItemize}
\item 
\mbox{\hyperlink{classcppgc_1_1Heap_ad5b1633ccc2d393c9e57ea830a9fb6ac}{Heap}} ()=default
\end{DoxyCompactItemize}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{60                          : uint8\_t \{\textcolor{comment}{}}
\DoxyCodeLine{61 \textcolor{comment}{    /**}}
\DoxyCodeLine{62 \textcolor{comment}{     * Atomic stop-\/the-\/world marking. This option does not require any write}}
\DoxyCodeLine{63 \textcolor{comment}{     * barriers but is the most intrusive in terms of jank.}}
\DoxyCodeLine{64 \textcolor{comment}{     */}}
\DoxyCodeLine{65     \mbox{\hyperlink{namespacecppgc_1_1internal_ac0b40b7e4ac65024fbfcf57d01fa808ea726d9cf5163c50b3cf8e05800e3cef71}{kAtomic}},\textcolor{comment}{}}
\DoxyCodeLine{66 \textcolor{comment}{    /**}}
\DoxyCodeLine{67 \textcolor{comment}{     * Incremental marking interleaves marking with the rest of the application}}
\DoxyCodeLine{68 \textcolor{comment}{     * workload on the same thread.}}
\DoxyCodeLine{69 \textcolor{comment}{     */}}
\DoxyCodeLine{70     kIncremental,\textcolor{comment}{}}
\DoxyCodeLine{71 \textcolor{comment}{    /**}}
\DoxyCodeLine{72 \textcolor{comment}{     * Incremental and concurrent marking.}}
\DoxyCodeLine{73 \textcolor{comment}{     */}}
\DoxyCodeLine{74     kIncrementalAndConcurrent}
\DoxyCodeLine{75   \};}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{45                           : uint8\_t \{\textcolor{comment}{}}
\DoxyCodeLine{46 \textcolor{comment}{    /**}}
\DoxyCodeLine{47 \textcolor{comment}{     * Conservative stack scan is supported.}}
\DoxyCodeLine{48 \textcolor{comment}{     */}}
\DoxyCodeLine{49     kSupportsConservativeStackScan,\textcolor{comment}{}}
\DoxyCodeLine{50 \textcolor{comment}{    /**}}
\DoxyCodeLine{51 \textcolor{comment}{     * Conservative stack scan is not supported. Embedders may use this option}}
\DoxyCodeLine{52 \textcolor{comment}{     * when using custom infrastructure that is unsupported by the library.}}
\DoxyCodeLine{53 \textcolor{comment}{     */}}
\DoxyCodeLine{54     kNoConservativeStackScan,}
\DoxyCodeLine{55   \};}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{80                           : uint8\_t \{\textcolor{comment}{}}
\DoxyCodeLine{81 \textcolor{comment}{    /**}}
\DoxyCodeLine{82 \textcolor{comment}{     * Atomic stop-\/the-\/world sweeping. All of sweeping is performed at once.}}
\DoxyCodeLine{83 \textcolor{comment}{     */}}
\DoxyCodeLine{84     \mbox{\hyperlink{namespacecppgc_1_1internal_ac0b40b7e4ac65024fbfcf57d01fa808ea726d9cf5163c50b3cf8e05800e3cef71}{kAtomic}},\textcolor{comment}{}}
\DoxyCodeLine{85 \textcolor{comment}{    /**}}
\DoxyCodeLine{86 \textcolor{comment}{     * Incremental sweeping interleaves sweeping with the rest of the}}
\DoxyCodeLine{87 \textcolor{comment}{     * application workload on the same thread.}}
\DoxyCodeLine{88 \textcolor{comment}{     */}}
\DoxyCodeLine{89     kIncremental,\textcolor{comment}{}}
\DoxyCodeLine{90 \textcolor{comment}{    /**}}
\DoxyCodeLine{91 \textcolor{comment}{     * Incremental and concurrent sweeping. Sweeping is split and interleaved}}
\DoxyCodeLine{92 \textcolor{comment}{     * with the rest of the application.}}
\DoxyCodeLine{93 \textcolor{comment}{     */}}
\DoxyCodeLine{94     kIncrementalAndConcurrent}
\DoxyCodeLine{95   \};}
...
\mbox{\Hypertarget{classcppgc_1_1Heap_ad5b1633ccc2d393c9e57ea830a9fb6ac}\label{classcppgc_1_1Heap_ad5b1633ccc2d393c9e57ea830a9fb6ac}} 
\index{cppgc::Heap@{cppgc::Heap}!Heap@{Heap}}
\index{Heap@{Heap}!cppgc::Heap@{cppgc::Heap}}
\doxysubsubsection{\texorpdfstring{Heap()}{Heap()}}
{\footnotesize\ttfamily cppgc\+::\+Heap\+::\+Heap (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}, {\ttfamily [default]}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{39                                                                  \{}
\DoxyCodeLine{40   \mbox{\hyperlink{src_2base_2logging_8h_ae17f8119c108cf3070bad3449c7e0006}{DCHECK}}(platform.get());}
\DoxyCodeLine{41   \mbox{\hyperlink{namespacecppgc_1_1anonymous__namespace_02heap_8cc_03_a38ba16caeb7c11816a4674d121baa33f}{VerifyCustomSpaces}}(options.custom\_spaces);}
\DoxyCodeLine{42   \textcolor{keywordflow}{return} std::make\_unique<internal::Heap>(std::move(platform),}
\DoxyCodeLine{43                                           std::move(options));}
\DoxyCodeLine{44 \}}

\end{DoxyCode}


References cppgc\+::\+Heap\+::\+Heap\+Options\+::custom\+\_\+spaces, DCHECK, and cppgc\+::anonymous\+\_\+namespace\{heap.\+cc\}\+::\+Verify\+Custom\+Spaces().
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classcppgc_1_1Heap_ae70ae70a49fe0af30a8878515cda4afc_cgraph}
\end{center}
\end{figure}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{47                                                                   \{}
\DoxyCodeLine{48   \mbox{\hyperlink{classcppgc_1_1internal_1_1Heap_a22613753e2437a9c3c9d0819059298b2}{internal::Heap::From}}(\textcolor{keyword}{this})-\/>\mbox{\hyperlink{classcppgc_1_1internal_1_1Heap_a13e01c3921c03e7f24d799ac8fbb1096}{CollectGarbage}}(}
\DoxyCodeLine{49       \{\mbox{\hyperlink{namespacecppgc_1_1internal_a9a435919d5a4a3ecfdfe20fb93896a60a94f16e44c50fb544fc2b1f177b913cbc}{internal::CollectionType::kMajor}}, stack\_state, \mbox{\hyperlink{classcppgc_1_1Heap_a3094861cfe8c736974723e4ad9ca3e20a726d9cf5163c50b3cf8e05800e3cef71}{MarkingType::kAtomic}},}
\DoxyCodeLine{50        \mbox{\hyperlink{classcppgc_1_1Heap_a9005da6b2685669d9b1419324e26b8a2a726d9cf5163c50b3cf8e05800e3cef71}{SweepingType::kAtomic}},}
\DoxyCodeLine{51        internal::GCConfig::FreeMemoryHandling::kDiscardWherePossible,}
\DoxyCodeLine{52        \mbox{\hyperlink{structcppgc_1_1internal_1_1MarkingConfig_a74d8f8edbbd41410753efcb241bca188af8ece195be5dd5e820bdeee7ad21a4bf}{internal::GCConfig::IsForcedGC::kForced}}\});}
\DoxyCodeLine{53 \}}

\end{DoxyCode}


References cppgc\+::internal\+::\+Heap\+::\+Collect\+Garbage(), cppgc\+::internal\+::\+Heap\+::\+From(), k\+Atomic, cppgc\+::internal\+::\+Marking\+Config\+::k\+Forced, and cppgc\+::internal\+::k\+Major.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classcppgc_1_1Heap_aa8ef2e6a66b5512a189ddfb7a3ab4f3d_cgraph}
\end{center}
\end{figure}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{55                                             \{}
\DoxyCodeLine{56   \textcolor{keywordflow}{return} \mbox{\hyperlink{classcppgc_1_1internal_1_1Heap_a22613753e2437a9c3c9d0819059298b2}{internal::Heap::From}}(\textcolor{keyword}{this})-\/>\mbox{\hyperlink{classcppgc_1_1internal_1_1HeapBase_a358b50366c16ce54f2270b2eb78c963c}{object\_allocator}}();}
\DoxyCodeLine{57 \}}

\end{DoxyCode}


References cppgc\+::internal\+::\+Heap\+::\+From(), and cppgc\+::internal\+::\+Heap\+Base\+::object\+\_\+allocator().
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classcppgc_1_1Heap_ab3137d30e4a524fc997ddae411640442_cgraph}
\end{center}
\end{figure}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{59 \{ \textcolor{keywordflow}{return} *\mbox{\hyperlink{classcppgc_1_1internal_1_1Heap_a22613753e2437a9c3c9d0819059298b2}{internal::Heap::From}}(\textcolor{keyword}{this}); \}}

\end{DoxyCode}


References cppgc\+::internal\+::\+Heap\+::\+From().
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classcppgc_1_1Heap_a3c9d9dcc6a11d868f1cf7d60ac53e27d_cgraph}
\end{center}
\end{figure}
...
\item 
/mnt/\+V8\+Source\+Code/include/cppgc/\mbox{\hyperlink{include_2cppgc_2heap_8h}{heap.\+h}}\item 
